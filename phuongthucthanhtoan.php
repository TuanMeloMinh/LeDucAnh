...
<div class="imformation">
  <div id="top-imformation">
    <h3>PHƯƠNG THỨC THANH TOÁN</h3>
      <br>
        <br>
        <strong><p><h2> - Trả tiền khi nhận hàng </h2></strong><br>Quý khách trả tiền mặt cho nhân viên giao hàng khi nhận được sản phẩm mình đặt mua.
        <br><br></p>
        <strong><p><h2> - Thanh toán chuyển khoản </h2></strong><br>Quý khách có thể thanh toán chuyển khoản trước cho đơn hàng của mình, quý khách sẽ được miễn phí vận chuyển nếu quý khách chuyển khoản trước cho đơn hàng của mình (Miễn phí ship - Có điều kiện là đơn hàng của quý khách có cân nặng không quá 5kg, nếu đơn hàng nặng trên 5kg thì sẽ hỗ trợ 50-70% phí vận chuyển)
        <br><br>Quý khách có thể thanh toán tiền trước theo hình thức chuyển khoản trên APP ngân hàng/ phòng giao dịch ngân hàng/ trên máy ATM
        <br><br></p> 
        <strong><p><h2> - Quý khách chuyển tiền vào tài khoản của một trong các ngân hàng sau:</h2></strong></p>
        <img src="images/vietcombank.png" style="width: 220px;height: 80px;" > 
        <br> Ngân hàng TMCP Ngoại Thương Việt Nam - Vietcombank
        <br><br>Số tài khoản: 
        <br><br>Chủ tài khoản:Phan Quang Tiến
        <br>-------------------------------------------------------------------
        <br>
        <img src="images/sacombank.png" style="width: 220px;height: 45px;" > 
        <br> Ngân hàng TMCP Sài Gòn Thương Tín 
        <br><br>Số tài khoản: 
        <br><br>Chủ tài khoản:Phan Quang Tiến
        <br>-------------------------------------------------------------------
        <br>
        <img src="images/techcombank.png" style="width: 220px;height: 80px;" > 
        <br>Ngân hàng TMCP Kỹ thương Việt Nam
        <br><br>Số tài khoản: 
        <br><br>Chủ tài khoản:Phan Quang Tiến
        <br>-------------------------------------------------------------------
        <br>
        <strong><p><h2>Lưu ý:</h2></p></strong>Quý khách trước khi nhấn nút đồng ý chuyển tiền, xin hãy cẩn thận xem lại màn hình hiện thị tên chủ tài khoản có phải là Phan Quang Tiến không? rồi hãy nhấn nút đồng ý.
        <br><br>          
  </div>
</div>
