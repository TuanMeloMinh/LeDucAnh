        ...
        <div class="listing-items">
            ...
            <ul>
                <li class="listing-item-heading">
                    ...
                    <div class="listing-prop listing-diachi">Địa Chỉ</div>
                    <!-- <div class="listing-prop listing-privilige">
                        Phân quyền
                    </div> -->
                ...
                while ($row = mysqli_fetch_array($products)) {
                    ...
                    <li>
                        ...
                        <div class="listing-prop listing-diachi"><?= $row['diachi'] ?></div>
                        <!-- <div class="listing-prop listing-privilige">
                            <a href="./<?=$config_name?>_editing.php?id=<?= $row['id'] ?>">Phân quyền</a>
                        </div> -->
